...
class ASTNode {
	public:
		...
		virtual void accept(CreatingVisitor *v)=0;
		virtual void accept(CheckingVisitor *v)=0;
...
class ProgNode : public ASTNode {
	public:
		...
		virtual void accept(CreatingVisitor *v) override;
		virtual void accept(CheckingVisitor *v) override;
};
